...
login-cookie-deezer-title = Paste your Deezer arl cookie to finish signing in
login-cookie-deezer-open = Open Deezer
login-cookie-deezer-hint = Paste the arl cookie here
login-cookie-deezer-step-1 = Open www.deezer.com and make sure you are signed in.
login-cookie-deezer-step-2 = Press F12 and open the Storage tab in Firefox, or the Application tab in Chrome.
login-cookie-deezer-step-3 = Expand Cookies, select https://www.deezer.com and find the cookie named arl.
login-cookie-deezer-step-4 = Double-click its value and copy it.
login-cookie-deezer-note = The arl value alone is enough. A whole Cookie header copied from the Network tab works too.
