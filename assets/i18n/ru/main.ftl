...
login-cookie-deezer-title = Вставьте cookie arl от Deezer, чтобы завершить вход
login-cookie-deezer-open = Открыть Deezer
login-cookie-deezer-hint = Вставьте сюда cookie arl
login-cookie-deezer-step-1 = Откройте www.deezer.com и убедитесь, что вы вошли в аккаунт.
login-cookie-deezer-step-2 = Нажмите F12 и откройте вкладку Хранилище в Firefox или Application в Chrome.
login-cookie-deezer-step-3 = Раскройте Cookies, выберите https://www.deezer.com и найдите cookie с именем arl.
login-cookie-deezer-step-4 = Дважды щёлкните по его значению и скопируйте его.
login-cookie-deezer-note = Достаточно одного значения arl. Целый заголовок Cookie из вкладки Сеть тоже подойдёт.
