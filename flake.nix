      ...
      release = {
        ...
        assets = {
          x86_64-linux = {
            ...
            hash = "sha256-KAfxV9vvixj6jlxFAHrYiJuB/gAWDQfVHF0fJv5A27U=";
          };
          aarch64-linux = {
            target = "aarch64-unknown-linux-gnu";
            hash = "sha256-d4pZ5t7N/3bIVIShJBg8Kq3TVJx6DGWwB7TKHekOr04=";
          };
          aarch64-darwin = {
            target = "macos";
            hash = "sha256-Bi4wmfTtokaQm+QUAVzF0EfdMBCSYPYcDIyZ9wJUyoY=";
          };
        };
      };
    in
